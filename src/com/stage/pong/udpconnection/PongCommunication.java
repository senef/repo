...
public class PongCommunication extends Observable {
    ...
    private class PongComThread extends Thread {
        ...
        public void run() {
    		...
    		try {
    			...
    			while (true) { 
	    			...
	    			//if(remoteIP.getHostAddress().equals(this.getLocalIpAddress()) || remoteIP==null)
        ...
        private synchronized void traiter(DatagramPacket packet) throws SocketException, UnknownHostException  {
			...
			String s = new String(packet.getData(), 0, packet.getLength());
             ...
             String str[]=s.split("/");
             if(D)Log.d(TAG, "Received response " + s+"----"+str[1]); 
        	switch (str[0]) {
            ...
            case "ping":
    			...
    			mHandler.obtainMessage(MenuController.MESSAGE_ASK,this.getLocalIpAddress())
    			.sendToTarget();
            ...
            case "posi":
    			...
    			mHandler.obtainMessage(PongControllerTwoPlayer.MESSAGE_READ, str[1])
    			.sendToTarget();
            	
                break;     
            case "sco":
            	Log.d("pos","sco : "+ str[1]);
			mHandler.obtainMessage(PongControllerTwoPlayer.MESSAGE_SCORE, str[1])
    			.sendToTarget();
